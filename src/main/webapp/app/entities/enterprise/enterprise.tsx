  ...
  return (
    <div>
      <h2 id="enterprise-heading" data-cy="EnterpriseHeading">
        <Translate contentKey="acrmApp.enterprise.home.title">Enterprises</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="acrmApp.enterprise.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/enterprise/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="acrmApp.enterprise.home.createLabel">Create new Enterprise</Translate>
          </Link>
        </div>
      </h2>
        ...
        {enterpriseList && enterpriseList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="acrmApp.enterprise.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('companyName')}>
                  <Translate contentKey="acrmApp.enterprise.companyName">Company Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('companyName')} />
                </th>
                <th className="hand" onClick={sort('businessRegisterNumber')}>
                  <Translate contentKey="acrmApp.enterprise.businessRegisterNumber">Business Register Number</Translate>{' '}
                ...
                <th className="hand" onClick={sort('uniqueIdentificationNumber')}>
                  <Translate contentKey="acrmApp.enterprise.uniqueIdentificationNumber">Unique Identification Number</Translate>{' '}
                ...
                <th className="hand" onClick={sort('country')}>
                  <Translate contentKey="acrmApp.enterprise.country">Country</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('country')} />
                </th>
                <th className="hand" onClick={sort('city')}>
                  <Translate contentKey="acrmApp.enterprise.city">City</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('city')} />
                </th>
                <th className="hand" onClick={sort('businessLogo')}>
                  <Translate contentKey="acrmApp.enterprise.businessLogo">Business Logo</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="acrmApp.enterprise.home.notFound">No Enterprises found</Translate>
            </div>
          )
        )}
      </div>
