  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="acrmApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="acrmApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('acrmApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('acrmApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('acrmApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('acrmApp.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField id="job-history-job" name="job" data-cy="job" label={translate('acrmApp.jobHistory.job')} type="select">
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('acrmApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('acrmApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
